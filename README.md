...
* Le corpus complet, avec les résultats fournis par GPTZero, se trouve dans le fichier [**corpusComplet.csv**](corpusComplet.csv) (le texte des articles moissonnés a été raccourci aux 100 premiers caractères afin de respecter le droit d'auteur des journalistes qui les ont rédigés); le texte généré par GPT-3 a cependant été conservé entièrement; mon fichier de données complet est accessible [sur demande](mailto:roy.jean-hugues@uqam.ca).
